...
//####################################################
//####################################################
// REMOVE BEFORE MAKING DOCKER IMAGE
// used for testing
//####################################################
 /*   
...
//    set('cluster_info', $clusterdetails);
    ...
    $clusterdetails .= '<ul class="list-group">  <li class="list-group-item">  <span class="badge badge-secondary" style="font-size:large; float:right;background-color: skyblue;color:#595959">'.$total_services.'</span>Services</li><li class="list-group-item"><span class="badge badge-secondary" style="font-size:large;float:right;background-color: lightgreen;color:#595959">'.$total_routes.'</span>Routes</li><li class="list-group-item"><span class="badge badge-secondary" style="font-size:large;float:right;background-color: pink;color:#595959">'.$total_plugins.'</span>Plugins</li></ul>';
    set('cluster_info', $clusterdetails);
