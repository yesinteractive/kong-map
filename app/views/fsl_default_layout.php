...
.demorow {
    ...
    <body>
    <script type="text/javascript" src="https://unpkg.com/vis-network@8.5.6/standalone/umd/vis-network.min.js"></script>
    <nav class="navbar navbar-light navbar-custom " style="justify-content: end;">
            <a class="navbar-brand" href="<?php echo $app_url?>">

                <span class="navbar-text" style="">KongMap</span>
            </a>
        ...
        <?php echo $navbar; ?>
            ...
            <span class="navbar-text" style="position: absolute; right: 10px;">
                <a href="https://github.com/yesinteractive/kong-map/blob/main/CHANGELOG.md" target="_blank">ver <?php echo option('kongmap_ver'); ?> </a></span>
